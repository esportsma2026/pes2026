var EffotbaleDraw = (function () {
  ...
  var COUNTRIES = [
    { id: 'brazil', name: 'Brazil', nameAr: 'البرازيل', flag: 'images/brazil.svg' },
    { id: 'portugal', name: 'Portugal', nameAr: 'البرتغال', flag: 'images/portugal.svg' },
    { id: 'france', name: 'France', nameAr: 'فرنسا', flag: 'images/france.svg' },
    { id: 'morocco', name: 'Morocco', nameAr: 'المغرب', flag: 'images/morocco.svg' },
    { id: 'argentina', name: 'Argentina', nameAr: 'الأرجنتين', flag: 'images/argentina.svg' },
    { id: 'spain', name: 'Spain', nameAr: 'إسبانيا', flag: 'images/spain.svg' },
    { id: 'netherlands', name: 'Netherlands', nameAr: 'هولندا', flag: 'images/netherlands.svg' },
    { id: 'japan', name: 'Japan', nameAr: 'اليابان', flag: 'images/japan.svg' },
    { id: 'germany', name: 'Germany', nameAr: 'ألمانيا', flag: 'images/germany.svg' },
    { id: 'england', name: 'England', nameAr: 'إنجلترا', flag: 'images/england.svg' },
    { id: 'croatia', name: 'Croatia', nameAr: 'كرواتيا', flag: 'images/croatia.svg' },
    { id: 'saudi-arabia', name: 'Saudi Arabia', nameAr: 'السعودية', flag: 'images/saudi-arabia.svg' },
    { id: 'italy', name: 'Italy', nameAr: 'إيطاليا', flag: 'images/italy.svg' },
    { id: 'belgium', name: 'Belgium', nameAr: 'بلجيكا', flag: 'images/belgium.svg' },
    { id: 'uruguay', name: 'Uruguay', nameAr: 'الأوروغواي', flag: 'images/uruguay.svg' },
    { id: 'south-korea', name: 'South Korea', nameAr: 'كوريا الجنوبية', flag: 'images/south-korea.svg' },
    { id: 'usa', name: 'USA', nameAr: 'الولايات المتحدة', flag: 'images/usa.svg' },
    { id: 'mexico', name: 'Mexico', nameAr: 'المكسيك', flag: 'images/mexico.svg' },
    { id: 'colombia', name: 'Colombia', nameAr: 'كولومبيا', flag: 'images/colombia.svg' },
    { id: 'ghana', name: 'Ghana', nameAr: 'غانا', flag: 'images/ghana.svg' },
    { id: 'senegal', name: 'Senegal', nameAr: 'السنغال', flag: 'images/senegal.svg' },
    ...
    { id: 'egypt', name: 'Egypt', nameAr: 'مصر', flag: 'images/egypt.svg' },
    { id: 'australia', name: 'Australia', nameAr: 'أستراليا', flag: 'images/australia.svg' },
    { id: 'iran', name: 'Iran', nameAr: 'إيران', flag: 'images/iran.svg' },
    { id: 'switzerland', name: 'Switzerland', nameAr: 'سويسرا', flag: 'images/switzerland.svg' },
    { id: 'denmark', name: 'Denmark', nameAr: 'الدنمارك', flag: 'images/denmark.svg' },
    { id: 'sweden', name: 'Sweden', nameAr: 'السويد', flag: 'images/sweden.svg' },
    { id: 'poland', name: 'Poland', nameAr: 'بولندا', flag: 'images/poland.svg' },
    { id: 'serbia', name: 'Serbia', nameAr: 'صربيا', flag: 'images/serbia.svg' },
    { id: 'turkiye', name: 'Türkiye', nameAr: 'تركيا', flag: 'images/turkiye.svg' },
    { id: 'canada', name: 'Canada', nameAr: 'كندا', flag: 'images/canada.svg' },
    { id: 'algeria', name: 'Algeria', nameAr: 'الجزائر', flag: 'images/algeria.svg' },
    { id: 'tunisia', name: 'Tunisia', nameAr: 'تونس', flag: 'images/tunisia.svg' },
    { id: 'ivory-coast', name: 'Ivory Coast', nameAr: 'ساحل العاج', flag: 'images/ivory-coast.svg' },
    { id: 'ecuador', name: 'Ecuador', nameAr: 'الإكوادور', flag: 'images/ecuador.svg' },
    { id: 'peru', name: 'Peru', nameAr: 'بيرو', flag: 'images/peru.svg' },
    { id: 'new-zealand', name: 'New Zealand', nameAr: 'نيوزيلندا', flag: 'images/new-zealand.svg' },
    { id: 'qatar', name: 'Qatar', nameAr: 'قطر', flag: 'images/qatar.svg' },
    { id: 'costa-rica', name: 'Costa Rica', nameAr: 'كوستاريكا', flag: 'images/costa-rica.svg' },
    { id: 'panama', name: 'Panama', nameAr: 'بنما', flag: 'images/panama.svg' },
    { id: 'scotland', name: 'Scotland', nameAr: 'اسكتلندا', flag: 'images/scotland.svg' },
    { id: 'austria', name: 'Austria', nameAr: 'النمسا', flag: 'images/austria.svg' },
    { id: 'czech-republic', name: 'Czech Republic', nameAr: 'التشيك', flag: 'images/czech-republic.svg' },
    { id: 'norway', name: 'Norway', nameAr: 'النرويج', flag: 'images/norway.svg' },
    { id: 'south-africa', name: 'South Africa', nameAr: 'جنوب أفريقيا', flag: 'images/south-africa.svg' },
    { id: 'iraq', name: 'Iraq', nameAr: 'العراق', flag: 'images/iraq.svg' }
  ];
